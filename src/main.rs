...
use bevy::{ecs::{query, system::entity_command::despawn}, prelude::*, state::commands};
...
fn setup_monster_zombie(
    ...
    commands.spawn((
        ...
        Transform::from_xyz(800.0, 20.0, 1.0)
    ));
}
...
fn setup_monster_toxick_zombie(
    ...
    commands.spawn((
        ...
        Transform::from_xyz(800.0,-10.0, 1.0)
    ));
}
...
fn setup_monster_fat_zombie(
    ...
    commands.spawn((
        ...
        Transform::from_xyz(800.0, -60.0, 1.0)
    ));
}
